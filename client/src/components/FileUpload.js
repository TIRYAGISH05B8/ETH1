...
const FileUpload = ({ contract, account, provider }) => {
  ...
  const [fileName, setFileName] = useState("No Patient Records selected");
    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `728b4ce315c015189f0b`,
            pinata_secret_api_key: `1f8c9570baa57b69af787ca3703615336e14f311f929a8a7da981b864bd20573`,
            "Content-Type": "multipart/form-data",
          },
        });
        const ImgHash = `https://gateway.pinata.cloud/ipfs/${resFile.data.IpfsHash}`;
        contract.add(account,ImgHash);
        alert("Successfully Patient Record Uploaded");
